...
My research focuses on *task-driven* methods for solving stochastic optimal control (SOC) problems with applications in *robotics*, *machine learning*, and *generative AI*. These methods exploit task-relevant information to synthesize control policies with improved generalization to new contexts or environments --- reducing data requirements and providing more reliable intelligent systems. My work provides algorithms to synthesize such policies as well as their theoretical foundations and performance guarantees.
